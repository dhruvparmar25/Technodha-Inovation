...
const serviceLinks = [
    ...
    { id: 2, name: "Mobile App Development", path: "/services/mobile-app" },
    { id: 3, name: "UI / UX Design", path: "/services/ui-ux" },
    { id: 4, name: "Cloud Computing", path: "/services/cloud" },
];
...
const Footer = () => {
    const navLinkClass = ({ isActive }) =>
        `block transition-colors duration-200 hover:text-[var(--light-color-secondary)] ${isActive ? "text-orange-500" : ""
        }`;
    ...
    return (
        <footer className="bg-bg text-text-secondary text-[13px]">
            ...
            <div className="px-6 xl:px-30 py-15 grid gap-12 grid-cols-2 sm:grid-cols-3 lg:grid-cols-4">
                ...
                <address className="not-italic">
                    ...
                    <p className="mb-3">
                        ...
                        >
                            <FaRegMessage size={16} className="text-(--light-color-secondary)" />
                    ...
                    <p>
                        <a
                            ...
                            className="flex items-center gap-2 hover:text-(--light-color-secondary) transition-colors"
                        >
                            <IoCallOutline size={16} className="text-(--light-color-secondary)" />
                            +91 9297626262
                        </a>
                    </p>
                </address>
            ...
            <div className="border-t border-[#2A2A33]">
                <nav className="px-6 xl:px-30 py-6 flex flex-col sm:flex-row items-center justify-center gap-4 text-[12px] text-white">
