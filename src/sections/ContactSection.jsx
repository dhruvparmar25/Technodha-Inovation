...
import ContactUs from "../assets/images/sections/contact/contact-gif.gif"

// ✅ Safe: static data moved outside component
const contactInfo = [
    {
        icon: <FaRegMessage size={16} />,
        text: "support@technoida.com",
    },
    {
            ...
            <div className="flex flex-col xl:flex-row gap-18 items-center">
                <div>
                    ...
                    <form className="flex flex-col gap-4 mt-10">
                        ...
                        <GradientButton
                            text="Send Message"
                            className="w-full lg:w-146.25 px-5 py-3 resize-none"
                        />
                    </form>
                </div>
                ...
                <div className="flex flex-col">
                    ...
                    <div className="text-[13px] text-[#5F5F6B]">
