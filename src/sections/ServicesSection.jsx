...
import Web from "../assets/images/sections/services/web-service.jpg"
import Webgif from "../assets/images/sections/services/web-gif.gif"

import App from "../assets/images/sections/services/app-service.jpg"
import Appgif from "../assets/images/sections/services/app-gif.gif"

import UiUx from "../assets/images/sections/services/uiux-service.jpg"
import UiUxgif from "../assets/images/sections/services/uiux-gif.gif"

import Cloud from "../assets/images/sections/services/cloud-service.jpg"
import Cloudgif from "../assets/images/sections/services/cloud-gif.gif"
        ...
        <section data-theme="light" className="bg-bg px-6 xl:px-30">
            ...
            <div className="text-center lg:text-left">
                ...
                <div className="heading-primary">
                    Core <span className="italic text-[#FB6557]">services</span>{" "}
                    behind scalable{" "}
                    <span className="italic text-[#6E5C59]">products</span>
                </div>

                <p className="text-support">
                    We offer focused services that help teams design, build,
                    and scale reliable digital products.
                </p>
            </div>
