...
import Aboutimg from "../assets/images/sections/about/about-main.png"
import Aboutimgone from "../assets/images/sections/about/about-one.jpg"
import Aboutimgtwo from "../assets/images/sections/about/about-two.jpg"
                    ...
                    <div className="block xl:hidden w-100 m-auto">
                        <div className="w-100 m-auto rounded-[14px] overflow-hidden">
                            <img
                                ...
                                className="w-100 m-auto h-auto object-cover"
                                loading="lazy"
                            />
                        </div>
                    </div>
